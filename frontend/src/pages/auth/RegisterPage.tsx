    ...
    <div className="bg-gray-50 font-sans min-h-screen flex text-gray-800 selection:bg-secondary selection:text-white">
        ...
        <div className="hidden lg:flex w-full lg:w-5/12 bg-[#001a33] relative justify-center items-center overflow-hidden">
            ...
            <div className="relative z-10 p-12 text-white max-w-lg">
                ...
                <h2 className="text-3xl font-bold mb-6 leading-tight text-white">Únete a nuestra red de transporte de primer nivel.</h2>
        ...
        <div className="w-full lg:w-7/12 flex flex-col justify-center items-center p-6 lg:p-12 bg-white relative overflow-y-auto h-screen">
            ...
            <Link to="/" className="absolute top-6 right-6 lg:top-10 lg:right-10 text-gray-400 hover:text-primary transition flex items-center gap-2 text-sm font-medium group z-20">
            ...
            <div className="w-full max-w-lg my-auto">
                ...
                <div className="lg:hidden flex justify-center mb-6">
                    <div className="w-14 h-14 bg-primary rounded-xl flex items-center justify-center text-white text-2xl font-bold shadow-md">EL</div>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Nombre Completo / Razón Social</label>
                            <div className="relative group">
                                <User className="absolute left-3 top-3 text-gray-400 group-focus-within:text-primary transition-colors" size={20} />
                                <input 
                                    {...register("fullName")}
                                    type="text" 
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                <CreditCard className="absolute left-3 top-3 text-gray-400 group-focus-within:text-primary transition-colors" size={20} />
                                <input 
                                    {...register("rut")}
                                    type="text" 
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                <Phone className="absolute left-3 top-3 text-gray-400 group-focus-within:text-primary transition-colors" size={20} />
                                <input 
                                    {...register("phone")}
                                    type="tel" 
                                    placeholder="+56 9 ..." 
                        ...
                        <div className="md:col-span-2">
                            ...
                            <div className="relative group">
                                <Mail className="absolute left-3 top-3 text-gray-400 group-focus-within:text-primary transition-colors" size={20} />
                                <input 
                                    {...register("email")}
                                    type="email" 
                        ...
                        <div className="md:col-span-2">
                            ...
                            <div className="relative group">
                                <MapPin className="absolute left-3 top-3 text-gray-400 group-focus-within:text-primary transition-colors" size={20} />
                                <input 
                                    {...register("address")}
                                    type="text" 
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                <Lock className="absolute left-3 top-3 text-gray-400 group-focus-within:text-primary transition-colors" size={20} />
                                <input 
                                    {...register("password")}
                                    type="password" 
                                    placeholder="••••••••" 
                        ...
                        <div className="flex items-start">
                            ...
                            <div className="ml-3 text-sm">
                                <label htmlFor="terms" className="font-medium text-gray-700">
                                    Acepto los <Link to="/terms" className="text-primary hover:text-secondary font-bold hover:underline">términos y condiciones</Link>
                                </label>
                            </div>
                        </div>
                 ...
                 <div className="mt-8 text-center text-sm text-gray-500">
                    <p>¿Ya tienes una cuenta? <Link to="/login" className="font-bold text-primary hover:text-secondary transition">Inicia sesión aquí</Link></p>
                </div>

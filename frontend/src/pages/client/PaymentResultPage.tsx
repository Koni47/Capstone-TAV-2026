    ...
    if (status === "loading") {
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center space-y-4">
                ...
                <h2 className="text-xl font-semibold text-gray-700">Validando transacción con el banco...</h2>
            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full text-center border-t-4 border-red-500">
                    ...
                    <div className="flex gap-3 justify-center">
                        <button onClick={() => navigate("/client/payment")} className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                            Intentar de nuevo
                        </button>
                        <Link to="/client/dashboard" className="px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-900">
                            Volver al inicio
                        </Link>
                    </div>
                </div>
            ...
            <div className="max-w-xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="p-8 space-y-6">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wide">Detalle del Servicio</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6">
                        ...
                        <Link to="/client/history" className="flex items-center justify-center gap-2 px-4 py-3 bg-primary text-white rounded-lg font-bold hover:bg-blue-800 transition shadow-md">

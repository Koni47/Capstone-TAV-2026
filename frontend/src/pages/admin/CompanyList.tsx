        ...
        <div className="space-y-6 animate-fadeIn">
            ...
            <div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">Gestión de empresas mineras, contratos y centros de costo.</p>
                    </div>
                    
                    <Link to="/admin/companies/new" className="bg-secondary hover:bg-orange-700 text-white px-5 py-2.5 rounded-lg shadow-md hover:shadow-lg transition flex items-center gap-2 font-bold">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
                   <div className="flex justify-between items-start">
                       <div>
                           <div className="text-xs font-bold text-gray-400 uppercase tracking-wide">Empresas Activas</div>
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
                   <div className="flex justify-between items-start">
                       <div>
                           <div className="text-xs font-bold text-gray-400 uppercase tracking-wide">Contratos Vigentes</div>
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
                   <div className="flex justify-between items-start">
                       <div>
                           <div className="text-xs font-bold text-gray-400 uppercase tracking-wide">Solicitudes Mes</div>
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
                   <div className="flex justify-between items-start">
                       <div>
                           <div className="text-xs font-bold text-gray-400 uppercase tracking-wide">Facturación Pend.</div>
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex flex-col md:flex-row gap-4">
               <div className="relative flex-1">
                  ...
                  <input type="text" placeholder="Buscar por nombre, rut o contacto..." className="pl-10 w-full border border-gray-300 rounded-lg py-2 focus:ring-primary focus:border-primary outline-none" />
               </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                            ...
                            {companies.map((company) => (
                                <tr key={company.id} className="hover:bg-gray-50 transition group">
                                    <td className="px-6 py-4">
                                        <Link to={`/admin/companies/${company.id}`} className="font-bold text-gray-900 hover:text-primary transition">{company.name}</Link>
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex items-center justify-end gap-2 text-gray-400">
                                            <Link to={`/admin/companies/${company.id}/edit`} className="p-2 hover:text-blue-600 hover:bg-blue-50 rounded-full transition" title="Editar">
                                                <Edit2 size={16} />
                                            </Link>
                                            <button className="p-2 hover:text-red-600 hover:bg-red-50 rounded-full transition" title="Eliminar">
                                                <Trash size={16} />
                                            </button>
                ...
                <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200">
                    <div className="text-sm text-gray-500">Mostrando <span className="font-bold">1-4</span> de <span className="font-bold">12</span> resultados</div>
                    <div className="flex gap-2">

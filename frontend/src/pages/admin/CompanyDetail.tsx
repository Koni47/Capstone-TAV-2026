    ...
    <div className="max-w-7xl mx-auto space-y-6 animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-3">
          ...
          <Link
            to="/admin/companies"
            className="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 px-4 py-2 rounded-lg flex items-center gap-2 transition shadow-sm font-medium"
          >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-primary to-blue-900 rounded-xl shadow-md p-6 text-white text-center">
            ...
            <p className="text-blue-100 text-sm mb-4">
              Contacta al soporte para gestionar cuentas de esta empresa.
            </p>
            <button className="bg-white text-primary hover:bg-gray-100 px-4 py-2 rounded-lg font-medium text-sm transition w-full">
              Contactar Soporte
            </button>
          </div>
        </div>
          ...
          <div className="p-6">
            <div className="space-y-3">
              {company.costCenters.map((cc) => (
                <div
                  key={cc.id}
                  className="p-3 border border-gray-200 rounded-lg hover:border-blue-300 transition cursor-pointer flex justify-between items-center bg-gray-50"
                >
                  <div>
            ...
            {company.contracts.map((contract) => (
              <div key={contract.id} className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                <div className="flex justify-between items-start mb-2">
                  <span className="bg-blue-200 text-blue-800 text-[10px] uppercase font-bold px-2 py-0.5 rounded">
                    {contract.status}
                  </span>

            ...
            <div className="hidden lg:block lg:w-5/12 relative bg-primary">
                ...
                <div className="absolute bottom-0 left-0 p-12 text-white z-10">
                    <blockquote className="border-l-4 border-secondary pl-4 mb-4">
                        <p className="text-xl font-medium italic">"Gestión eficiente para relaciones duraderas."</p>
                    </blockquote>
                ...
                <div className="max-w-3xl mx-auto p-6 md:p-12">
                    ...
                    <nav className="flex text-sm text-gray-500 mb-6">
                        <ol className="flex items-center space-x-2">
                            ...
                            <li><span className="text-gray-400">/</span></li>
                            <li className="text-gray-900 font-medium">{isNew ? "Nueva Empresa" : "Editar Empresa"}</li>
                        </ol>
                    </nav>

                    <div className="mb-8 flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 mb-2">{isNew ? "Registrar Empresa" : "Editar Empresa"}</h1>
                            <p className="text-gray-600">Actualice la información comercial y puntos de contacto.</p>
                        </div>
                        <button 
                            onClick={() => navigate(-1)}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8 bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-200 animate-fadeIn">

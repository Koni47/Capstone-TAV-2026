      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/3 space-y-6">
          <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
            ...
            <div className="px-6 pb-6 text-center relative">
              ...
              <p className="text-sm text-gray-500 mb-4 capitalize">
                {user?.role ? user.role.toLowerCase() : 'Cliente Corporativo'}
              </p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-2">
            <a
              href="#"
              className="flex items-center gap-3 px-4 py-3 bg-blue-50 text-primary font-medium rounded-lg transition"
            >
              <User size={18} /> Información Personal
            </a>
            <a
              href="#"
              className="flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-lg transition"
            >
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Contacte al administrador para cambiar el correo.
                </p>
              </div>
              ...
              <div className="col-span-1 md:col-span-2 flex justify-end">
                <button
                  type="submit"
                  className="bg-primary hover:bg-blue-800 text-white font-bold py-2 px-6 rounded-lg shadow-md transition transform hover:-translate-y-0.5"
                >
                  Guardar Cambios
                </button>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 sm:p-8">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="flex justify-end mt-4">
                <button
                  type="button"
                  className="text-secondary font-bold hover:text-orange-700 text-sm"
                >

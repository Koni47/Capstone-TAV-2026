...
const ComplaintsPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simular envío
    alert(
      'Su solicitud ha sido registrada correctamente. Nos pondremos en contacto a la brevedad.',
    );
    if (isAuthenticated) {
      navigate('/dashboard');
    } else {
        ...
        <div className="max-w-3xl w-full mx-auto space-y-8 animate-fadeIn">
          ...
          <div className="text-center md:text-left">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              Canal de Denuncias y Sugerencias
            </h1>
            <p className="text-gray-600">
              Su opinión es fundamental para nosotros. Utilice este formulario para reportar
              irregularidades, reclamos o sugerir mejoras.
            </p>
          </div>
          ...
          >
              ...
              <div className="bg-blue-50/50 p-4 rounded-lg border border-blue-100">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-700 font-medium">
                    Deseo mantener mi identidad en el anonimato
                  </span>
                </label>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-gray-100 flex justify-end gap-3">
              <Link
                to={isAuthenticated ? '/dashboard' : '/'}
                className="px-5 py-2.5 rounded-lg border border-gray-300 text-gray-700 hover:bg-white hover:text-primary transition font-medium bg-white"
              >
                Cancelar
              </Link>
              <button
                type="submit"
                className="px-6 py-2.5 rounded-lg bg-primary text-white hover:bg-blue-900 transition font-medium shadow-md hover:shadow-lg flex items-center gap-2"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-blue-50 rounded-xl p-6 border border-blue-100 text-primary h-full">
              ...
              <p className="text-sm mb-4 leading-relaxed text-blue-900">
                Todas las denuncias son revisadas por nuestro comité de ética en un plazo máximo de
                48 horas hábiles, garantizando confidencialidad.
              </p>
              <div className="text-sm font-semibold border-t border-blue-200 pt-3 flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  <Mail size={16} /> denuncias@elloa.cl
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                <details className="group">
                  ...
                  <p className="text-xs text-gray-500 mt-2 leading-relaxed">
                    Sí, nuestro sistema permite el anonimato total si así lo seleccionas en el
                    formulario.
                  </p>
                </details>
                ...
                <details className="group">
                  ...
                  <p className="text-xs text-gray-500 mt-2 leading-relaxed">
                    Acusamos recibo en 24 horas y entregamos resolución preliminar en 5 días.
                  </p>
                </details>
              </div>
            </div>
